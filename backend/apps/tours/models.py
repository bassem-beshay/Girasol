...
class Tour(TimeStampedModel, SluggedModel, SEOModel, PublishableModel):
    ...
    short_description = CKEditor5Field(config_name='default')
    short_description_es = CKEditor5Field('Short Description (Spanish)', config_name='default', blank=True)
    short_description_pt = CKEditor5Field('Short Description (Portuguese)', config_name='default', blank=True)
...
class EarlyBookingOffer(TimeStampedModel):
    ...
    title_es = models.CharField('Title (Spanish)', max_length=200, blank=True)
    title_pt = models.CharField('Title (Portuguese)', max_length=200, blank=True)
    subtitle = CKEditor5Field(config_name='default', blank=True)
    subtitle_es = CKEditor5Field('Subtitle (Spanish)', config_name='default', blank=True)
    subtitle_pt = CKEditor5Field('Subtitle (Portuguese)', config_name='default', blank=True)
