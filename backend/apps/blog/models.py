...
class Post(TimeStampedModel, SluggedModel, SEOModel, PublishableModel):
    ...
    excerpt = CKEditor5Field(config_name='default')
    excerpt_es = CKEditor5Field('Excerpt (Spanish)', config_name='default', blank=True)
    excerpt_pt = CKEditor5Field('Excerpt (Portuguese)', config_name='default', blank=True)
