...
class Destination(TimeStampedModel, SluggedModel, SEOModel, SortableModel):
    ...
    tagline = CKEditor5Field(config_name='default', blank=True)
    tagline_es = CKEditor5Field('Tagline (Spanish)', config_name='default', blank=True)
    tagline_pt = CKEditor5Field('Tagline (Portuguese)', config_name='default', blank=True)
