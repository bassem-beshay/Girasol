...
old_block = """            <div className="flex flex-col sm:flex-row items-center gap-3 text-sm text-white/70">
              ...
              <div className="flex items-center gap-6 order-1 sm:order-2 sm:ml-auto sm:mr-[10%]">
...
new_block = """            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-3 text-xs md:text-sm text-white/70">
...
if old_block in content:
    ...
    print("Updated footer bottom bar for mobile/tablet")
else:
