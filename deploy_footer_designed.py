...
old_block = """            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/70">
...
new_block = """            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/70">
              <p className="order-2 sm:order-1">
                © {new Date().getFullYear()} Girasol Egypt Travel and Tours. All rights reserved. | Designed by <a href="tel:+201228986508" className="text-white/90 hover:text-white transition-colors">ENG-Bassem Beshay</a>
              </p>
              <div className="flex items-center gap-6 order-1 sm:order-2">
                <Link href="/terms" className="hover:text-white transition-colors">
                  Terms & Conditions
...
if old_block in content:
    ...
    print("Updated - moved Designed by next to copyright")
else:
